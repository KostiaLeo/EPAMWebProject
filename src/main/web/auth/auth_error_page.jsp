...
<body class="register">
<center>
    <img src="${request.contextPath}/auth/img/problem.png" style="width: 20em; height: 20em; margin-top: 15%">
    <h1 style="font-size: 4em; color: #fff"><fmt:message key="errorPage.error"/></h1>
</center>
</body>
</html>
